...
class Show_in_Console(ABC,UserDict):
    @abstractmethod
    def show(self):
        pass

class Book(Show_in_Console):
    # work with contact
    ...
    def show_contact(self, search_data):
        ...
        if data:
            ...
            Book.show(data, headers, 'rounded_outline')
        else:
    ...
    def show_all(self):
        ...
        headers = ('Name', 'Phones', 'Email', 'Birthday', 'Address')
        Book.show(data, headers, "mixed_grid")
...
# func to show the list of contact's with birthdays which are in 'N' days from today
    ...
    def show(data: list, headers='firstrow', format="mixed_grid"):
